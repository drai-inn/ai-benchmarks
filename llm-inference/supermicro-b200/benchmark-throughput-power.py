...
#        use_beam_search=args.use_beam_search,
    ...
    # Benchmark.
    print(f"Start of benchmark: {datetime.datetime.now()}")
    start_time = time.perf_counter()
    llm.generate(dummy_inputs, sampling_params=sampling_params, use_tqdm=False)
    end_time = time.perf_counter()
    print(f"End of benchmark: {datetime.datetime.now()}")
    ...
    csv_file = "results_power_" + str(split_string(args.model)) + ".csv"
